...
class _PurchasedProductScreenState
    extends ViewWidget<PurchasedProductScreen, PurchasedProductModel> {
  @override
      ...
      body: Obx(() {
        return SingleChildScrollView(
          ...
          child: Container(
            ...
            child: Visibility(
              visible: viewModel.listProduct != null,
              child: Column(
                children: <Widget>[
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Visibility(
                          visible: (viewModel.listProduct?.length ?? 0) > 0,
                          child: GridView.builder(
                            shrinkWrap: true,
                            itemCount: viewModel.listProduct?.length ?? 0,
  ...
  @override
  PurchasedProductModel createViewModel() => getIt<PurchasedProductModel>();
}
