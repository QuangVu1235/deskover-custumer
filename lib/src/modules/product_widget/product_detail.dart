            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  //                 mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  //                 children: [
                  //                   Text(viewModel.starAvg.value.toString(),
                  //                     style: const TextStyle(
                  //                       fontSize: 18,
                  //                       color: UIColors.brandA,
                  //                       fontWeight: FontWeight.w700,
                  ...
                  //                     children: [
                  //                       RatingBar.builder(
                  //                         initialRating: viewModel.starAvg.value,
                  //                         minRating: 1,
                  //                         itemSize: 12,
                  ...
                  //                       ),
                  //                       Text("(${viewModel.comment.value?.data?.length ?? 0} đánh giá)",
                  //                           style: const TextStyle(
                  //                               fontSize: 12,
                  //                               fontWeight: FontWeight.w400)),
                  //                     ],
                  ...
                  //                           value: viewModel.starCountList[4].toDouble() / (viewModel.comment.value?.data?.length ?? 1).toDouble(),
                  //                           color: Colors.amber,
                  //                         ),
                  //                       ),
                  //                     ),
                  ...
                  //                   // ),
                  //                 ),
                  //                 Text(viewModel.starCountList[4].toString(),
                  //                   style: const TextStyle(
                  //                     fontSize: 14.0,
                  //                     fontWeight: FontWeight.w400,
                  //                   ),
