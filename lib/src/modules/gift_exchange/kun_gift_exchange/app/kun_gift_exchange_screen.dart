...
import 'kun_gift_product_screen.dart';
...
class _GiftExchangeScreenState extends State<GiftExchangeScreen> with TickerProviderStateMixin {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Đổi quà Kun',style: TextStyle(fontSize: 14,fontWeight: FontWeight.w700),),
        backgroundColor: UIColors.white,
      ),
      body: Column(
                  ...
                  padding: EdgeInsets.all(10),
                    child: SingleChildScrollView(
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Text("CÙNG KUN SĂN QUÀ TẾT, KẾT YÊU THƯƠNG",
                              style: TextStyle(
                                fontSize: 15,
